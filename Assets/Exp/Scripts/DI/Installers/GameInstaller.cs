using System;
using Exp.Scripts.Enemies.Asteroid;
using Exp.Scripts.GameLogics;
using Exp.Scripts.Helpers;
using Exp.Scripts.Player;
using Exp.Scripts.Player.States;
using Exp.Scripts.Util;
using UnityEngine;
using Zenject;
using Asteroid = Exp.Scripts.Enemies.Asteroid.Asteroid;
using AsteroidManager = Exp.Scripts.Enemies.Asteroid.AsteroidManager;
using AudioHandler = _Skycall.Scripts.Audio.AudioHandler;
using LevelHelper = Exp.Scripts.Helpers.LevelHelper;

namespace Exp.Scripts.DI.Installers
{
